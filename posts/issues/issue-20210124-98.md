...
Welcome to the Issue #98 of *Swift for TensorFlow Newsletter*. A newsletter letter that summarizes weekly activity around the Swift for TensorFlow project.
...
* [Rahul Bhalley](https://twitter.com/rahul_bhalley) has announced the release of his book: [Deep Learning with Swift for TensorFlow](https://www.apress.com/gp/book/9781484263297). You can grab a copy from [Amazon](https://www.amazon.com/Deep-Learning-Swift-TensorFlow-Differentiable-ebook/dp/B08T24JX6F), [Apress](https://www.apress.com/gp/book/9781484263297), [Springer](https://link.springer.com/book/10.1007%2F978-1-4842-6330-3) or read it at [O'Reilly](https://www.oreilly.com/library/view/deep-learning-with/9781484263303/).

## S4TF Commits

#### Swift Compiler (main branch)

* [PR-35329](https://github.com/apple/swift/pull/35329): Removes `_Differentiable.zeroTangentVectorInitializer`.

#### Swift TensorFlow APIs

* [PR-1181](https://github.com/tensorflow/swift-apis/pull/1181): Removes `zeroTangentVector` test.
