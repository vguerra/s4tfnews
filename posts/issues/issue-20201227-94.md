...
S4TF News - Issue 94, December 27th 2020
===================

Welcome to the Issue #94 of *Swift for TensorFlow Newsletter*. A newsletter letter that summarizes weekly activity around the Swift for TensorFlow project.
...
* [PR-35217](https://github.com/apple/swift/pull/35217): Disables flaky test on Linux.

* [PR-35194](https://github.com/apple/swift/pull/35194): Adds documentation explaining differentiable programming test suite.

#### Swift TensorFlow APIs

* [PR-1164](https://github.com/tensorflow/swift-apis/pull/1164): Adjusts structure of developer guide.

* [PR-1165](https://github.com/tensorflow/swift-apis/pull/1165): Documents how to query the toolchain identifier and use that to build the Swift APIs package.

* [PR-1162](https://github.com/tensorflow/swift-apis/pull/1162): Annotates functions using `_forEachFieldWithKeyPath`.

* [PR-1161](https://github.com/tensorflow/swift-apis/pull/1161): Improves explanation for CMake based builds.

* [PR-1157](https://github.com/tensorflow/swift-apis/pull/1157): Adds documentation covering how to build `X10` for Windows, Linux,
and macOS as well as links to prebuilt binaries.

#### Swift Models

* [PR-725](https://github.com/tensorflow/swift-models/pull/725): Fixes device placement when calculating statistics.

* [PR-724](https://github.com/tensorflow/swift-models/pull/724): Does cleanups for stock toolchain.
