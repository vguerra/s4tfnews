...
S4TF News - Issue 95, January 3rd 2021
===================

Welcome to the Issue #95 of *Swift for TensorFlow Newsletter*. A newsletter letter that summarizes weekly activity around the Swift for TensorFlow project.
...
* [PR-1173](https://github.com/tensorflow/swift-apis/pull/1173): Attempts to use `bash` for `SWIFTFLAGS`.

* [PR-1174](https://github.com/tensorflow/swift-apis/pull/1174): Renames `@_functionBuilder` to `@resultBuilder`.

* [PR-1156](https://github.com/tensorflow/swift-apis/pull/1156): Bumps to `TensorFlow` 2.4.0.

* [PR-1169](https://github.com/tensorflow/swift-apis/pull/1169): Adjusts `Swift`, `Clang`, linker flags.
