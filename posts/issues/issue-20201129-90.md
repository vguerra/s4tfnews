...
S4TF News - Issue 90, November 29th 2020
===================

Welcome to the Issue #90 of *Swift for TensorFlow Newsletter*. A newsletter letter that summarizes weekly activity around the Swift for TensorFlow project.
...
* [PR-34861](https://github.com/apple/swift/pull/34861): Rejects function types where all parameters are `@noDerivative`.

#### Swift Models

* [PR-702](https://github.com/tensorflow/swift-models/pull/702): Renames `Benchmarks` to `SwiftModelsBenchmarks` due to issues on depending on pckages with same target name.
