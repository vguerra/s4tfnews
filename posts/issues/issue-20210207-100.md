...
S4TF News - Issue 100, February 7th 2021
===================

Welcome to the Issue #100 of *Swift for TensorFlow Newsletter*. A newsletter letter that summarizes weekly activity around the Swift for TensorFlow project.
...
* [PR-35811](https://github.com/apple/swift/pull/35811): Adds `@differentiable(reverse)`.

#### Swift for Tensorflow Docs

* [PR-604](https://github.com/tensorflow/swift/pull/604): Adds initial guide to Tensors, along with a general docs Readme.
