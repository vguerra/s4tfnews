...
S4TF News - Issue 81, September 27th 2020
===================

Welcome to the Issue #81 of *Swift for TensorFlow Newsletter*. A newsletter letter that summarizes weekly activity around the Swift for TensorFlow project.
...
* [PR-1090](https://github.com/tensorflow/swift-apis/pull/1090): Fixes test failures caused by `Optional: KeyPathIterable` conformance.

* [PR-1088](https://github.com/tensorflow/swift-apis/pull/1088): Adds squeezing with no dimensions. Resolves [Issue-537](https://github.com/tensorflow/swift/issues/537).

#### Swift Models

* [PR-668](https://github.com/tensorflow/swift-models/pull/668): Refactors progress printer and adds `CSVLogger`. Partially resolves [Issue-663](https://github.com/tensorflow/swift-models/issues/663).
